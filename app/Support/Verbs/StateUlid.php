...
/**
 * ULID-aware replacement for #[StateId].
 *
 * Works like StateId but generates ULIDs instead of snowflakes
 * when autofilling null IDs on events.
 */
#[Attribute(Attribute::TARGET_PROPERTY)]
class StateUlid extends StateDiscoveryAttribute
{
    ...
    public function __construct(
        ...
        if (! is_a($this->state_type, State::class, true)) {
            throw new InvalidArgumentException('You must pass state class names to the "StateUlid" attribute.');
        }
    }
